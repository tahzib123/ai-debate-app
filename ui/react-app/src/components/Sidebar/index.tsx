    ...
    <aside className="w-full h-full glass border-r border-slate-700/30 flex flex-col overflow-hidden">
      ...
      <div className="p-4 lg:p-6 border-t border-slate-700/30 flex-shrink-0">
        ...
        <div className="flex gap-2">
          <button className="flex-1 px-3 py-2 bg-gradient-to-r from-blue-500 to-purple-500 text-white text-sm font-medium rounded-lg hover:shadow-lg hover:scale-105 transition-all duration-200 min-w-0">
